// Cross-company brand-gap data endpoint (used by the twice-weekly on-demand gap check).
// Pulls Voluum groupBy=trafficSource,customVariable8 for a date range and returns
// per (network|blog|merchant|country) aggregates with traffic-source split.
// customVariable8 encodes: [country] [campaign] [network] [blog] merchant.com # id
// Guarded by ?k=gapscan2026 (low-sensitivity aggregated data; same Voluum creds as voluum-test).
